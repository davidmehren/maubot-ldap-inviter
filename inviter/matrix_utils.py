...
class MatrixUtils:
    ...
    async def ensure_room_visibility(
        self, evt: MessageEvent, room_id: RoomID, visibility: str
    ):
    ...
    async def ensure_room_name(
        self, evt: MessageEvent, room_id: RoomID, name: str
    ) -> None:
    ...
    async def ensure_room_invitees(
        self, evt: MessageEvent, room_id: RoomID, user_info_map: UserInfoMap
    ):
